...
{
    /**
     * @var \Wind\Csn\Controller\UserController
     */
    ...
    {
        parent::setUp();
        $this->subject = $this->getMockBuilder(\Wind\Csn\Controller\UserController::class)
    ...
    public function listActionFetchesAllUsersFromRepositoryAndAssignsThemToView()
    {
        ...
        $userRepository = $this->getMockBuilder(\Wind\Csn\Domain\Repository\UserRepository::class)
            ->setMethods(['findAll'])
            ->disableOriginalConstructor()
            ->getMock();
    ...
    {
        $user = new \Wind\Csn\Domain\Model\User();
