#
# Table structure for table 'tx_csn_domain_model_user'
#
CREATE TABLE tx_csn_domain_model_user (
...
#
# Table structure for table 'tx_csn_domain_model_post'
#
CREATE TABLE tx_csn_domain_model_post (
