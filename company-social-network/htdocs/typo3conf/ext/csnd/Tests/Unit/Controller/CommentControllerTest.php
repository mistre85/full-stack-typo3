...
{
    /**
     * @var \Wind\Csnd\Controller\CommentController
     */
    ...
    {
        parent::setUp();
        $this->subject = $this->getMockBuilder(\Wind\Csnd\Controller\CommentController::class)
    ...
    public function listActionFetchesAllCommentsFromRepositoryAndAssignsThemToView()
    {
        ...
        $commentRepository = $this->getMockBuilder(\Wind\Csnd\Domain\Repository\CommentRepository::class)
            ->setMethods(['findAll'])
            ->disableOriginalConstructor()
            ->getMock();
