...
return [
    'ctrl' => [
        ...
        'searchFields' => 'text,user,likes,commenti',
        'iconfile' => 'EXT:csnd/Resources/Public/Icons/tx_csnd_domain_model_post.gif'
    ],
    'interface' => [
        'showRecordFieldList' => 'sys_language_uid, l10n_parent, l10n_diffsource, hidden, text, user, likes, commenti',
    ],
    'types' => [
        '1' => ['showitem' => 'sys_language_uid, l10n_parent, l10n_diffsource, hidden, text, user, likes, commenti, --div--;LLL:EXT:frontend/Resources/Private/Language/locallang_ttc.xlf:tabs.access, starttime, endtime'],
    ],
    'columns' => [
        'sys_language_uid' => [
            'exclude' => true,
	    ...
	    'commenti' => [
	        'exclude' => true,
	        'label' => 'LLL:EXT:csnd/Resources/Private/Language/locallang_db.xlf:tx_csnd_domain_model_post.commenti',
	        'config' => [
			    'type' => 'inline',
			    'foreign_table' => 'tx_csnd_domain_model_commenti',
			    'foreign_field' => 'post',
			    'maxitems' => 9999,
			    'appearance' => [
			        'collapseAll' => 0,
