...
{
    /**
     * @var \Wind\Csndata\Controller\PostController
     */
    ...
    {
        parent::setUp();
        $this->subject = $this->getMockBuilder(\Wind\Csndata\Controller\PostController::class)
    ...
    public function listActionFetchesAllPostsFromRepositoryAndAssignsThemToView()
    {
        ...
        $postRepository = $this->getMockBuilder(\Wind\Csndata\Domain\Repository\PostRepository::class)
            ->setMethods(['findAll'])
            ->disableOriginalConstructor()
            ->getMock();
    ...
    {
        $post = new \Wind\Csndata\Domain\Model\Post();
