<?php
namespace Wind\Csndata\Tests\Unit\Controller;
...
{
    /**
     * @var \Wind\Csndata\Controller\UserController
     */
    ...
    {
        parent::setUp();
        $this->subject = $this->getMockBuilder(\Wind\Csndata\Controller\UserController::class)
    ...
    public function listActionFetchesAllUsersFromRepositoryAndAssignsThemToView()
    {
        ...
        $userRepository = $this->getMockBuilder(\Wind\Csndata\Domain\Repository\UserRepository::class)
            ->setMethods(['findAll'])
            ->disableOriginalConstructor()
            ->getMock();
    ...
    {
        $user = new \Wind\Csndata\Domain\Model\User();
