#
# Table structure for table 'tx_csndata_domain_model_user'
#
CREATE TABLE tx_csndata_domain_model_user (
...
#
# Table structure for table 'tx_csndata_domain_model_post'
#
CREATE TABLE tx_csndata_domain_model_post (
