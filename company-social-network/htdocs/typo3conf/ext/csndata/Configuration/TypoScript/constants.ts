...
plugin.tx_csndata_frontendplugin {
  view {
    # cat=plugin.tx_csndata_frontendplugin/file; type=string; label=Path to template root (FE)
    templateRootPath = EXT:csndata/Resources/Private/Templates/
    # cat=plugin.tx_csndata_frontendplugin/file; type=string; label=Path to template partials (FE)
    partialRootPath = EXT:csndata/Resources/Private/Partials/
    # cat=plugin.tx_csndata_frontendplugin/file; type=string; label=Path to template layouts (FE)
    layoutRootPath = EXT:csndata/Resources/Private/Layouts/
  }
  persistence {
    # cat=plugin.tx_csndata_frontendplugin//a; type=string; label=Default storage PID
    storagePid =
  }
}
