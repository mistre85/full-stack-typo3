...
module.tx_csndata_cnsmodule {
  view {
    # cat=module.tx_csndata_cnsmodule/file; type=string; label=Path to template root (BE)
    templateRootPath = EXT:csndata/Resources/Private/Backend/Templates/
    # cat=module.tx_csndata_cnsmodule/file; type=string; label=Path to template partials (BE)
    partialRootPath = EXT:csndata/Resources/Private/Backend/Partials/
    # cat=module.tx_csndata_cnsmodule/file; type=string; label=Path to template layouts (BE)
    layoutRootPath = EXT:csndata/Resources/Private/Backend/Layouts/
  }
  persistence {
    # cat=module.tx_csndata_cnsmodule//a; type=string; label=Default storage PID
    storagePid = 1
  }
}
